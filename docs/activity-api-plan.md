...
> **复核状态（2026-09-06）**：P1–P5 全部完成上线，与线上 `worker.js` @ ba1377f 逐项核对一致（含「无 activity_detail_v1」「详情无 participants」「Image Resizing 已开启」等结论）。本章节作为活动功能的**权威实现说明**，README.md 摘要引用本文件。
